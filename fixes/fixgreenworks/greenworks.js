...
var archtypes = {
  ...
  'win32': {
    ...
    'ia32': 'greenworks-win32',
  },
  'linux': {
    'x64': 'greenworks-linux64',
    'ia32': 'greenworks-linux32',
  },
};
var libpath = __dirname;
var libname = archtypes[process.platform][process.arch];
greenworks = require(path.join(libpath,libname));
